    ...
    <div className="fixed inset-0 z-0 pointer-events-none" aria-hidden="true">
      <div className="absolute inset-0">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to bottom, rgba(0, 0, 0, 0.7) 0%, rgba(0, 0, 0, 0.6) 5%, rgba(0, 0, 0, 0.5) 10%, rgba(0, 0, 0, 0.35) 15%, rgba(0, 0, 0, 0.20) 20%, rgba(0, 0, 0, 0.10) 25%, rgba(0, 0, 0, 0.05) 30%, transparent 35%, transparent 100%)",
          }}
        />
      </div>
